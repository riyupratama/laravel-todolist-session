...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    ...
    <div class="row align-items-center g-lg-5 py-5">
        <div class="col-lg-7 text-center text-lg-start">
            ...
            <span class="col-lg-10 fs-4 text-primary">Riyu Todolist data with session</span><br>
            <span class="text-muted mt-0">Only use session to keep data (no use Database)</span>
        </div>
